...
const InfoItem = ({ Icon, label, value, bgColor }) => (
    <div className={`flex border border-dashed items-center mb-2 p-3 rounded-md hover:bg-gray-200 text-opacity-70 transition-all duration-300 ease-in-out ${bgColor}`}>
...
const UserAboutComponent = ({ userData, showEditButton }) => {
    ...
    return (
        <div className="flex flex-col w-[300px] shadow-md bg-white rounded-lg p-5">
            <div className="mb-6">
                <h2 className="text-2xl font-semibold border-b pb-2 mb-4">About</h2>
            </div>
            ...
            {showEditButton && (
                <Button
                    className="font-poppins mt-4 bg-blue-500 text-white rounded-md px-4 py-2 hover:bg-blue-600 transition-colors duration-300"
