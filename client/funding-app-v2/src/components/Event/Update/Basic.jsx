...
const BasicUpdate = React.forwardRef(({ onNextStep, currentData }, ref) => {
        ...
        <div className="flex flex-col items-start justify-start gap-6 text-gray-800">
            ...
            <div className="flex flex-col items-start justify-start mt-4">
                ...
                <input
                    type="text"
                    id="title"
                    className="mt-2 border rounded p-2 w-[600px]"
                    value={title}
            ...
            <div className="flex flex-col items-start justify-start mt-4">
                ...
                <textarea
                    id="description"
                    className="mt-2 border rounded p-2 w-[600px] h-[120px]"
                    value={description}
